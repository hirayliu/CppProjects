...
public:
    ...
    bool get_debug_v() const { return debug_v; }
    ...
    // void UpdatePosition(Edge *e) { edges_pq.update_position(e); }
    
    // sanity check
    void Check() const;
    // void CheckHeap() const { edges_pq.check_heap(); }
...
private:
    ...
    bool preserve_area;
    bool debug;
    bool debug_v;   // for verbose debugging
