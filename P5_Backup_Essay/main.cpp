...
// Part 1: test the copy constructor, assignment operator, and destructor
    {
        Essay my_essay = load("the quick brown fox jumped over the lazy dogs");
        assert(print(my_essay) == "the quick brown fox jumped over the lazy dogs");
        std::cout << "\nTESTING copy constructor, assignment operator, and destructor" << std::endl;
        // copy constructor
        Essay essay1(my_essay);
        std::cout << "Copy contructor:  " << print(essay1) << std::endl;
        // assignment operator
        Essay essay2 = essay1;
        std::cout << "Assignment operator:  " << print(essay2) << std::endl;
        // changes to essay2
        Essay::iterator ptr = essay2.begin();
        ptr++;
        ptr++;
        assert(*ptr == "brown");
        essay2.erase(ptr);
        assert(print(essay2) == "the quick fox jumped over the lazy dogs");
        std::cout << "Erasing brown:  " << print(essay2) << std::endl;
        // assignment operator, again
        essay2 = essay1;
        assert(print(essay2) == "the quick brown fox jumped over the lazy dogs");
        std::cout << "Assigned from essay1:  " << print(essay2) << std::endl;
        // destructors
        std::cout << "Destructors for essay1 and essay2" << std::endl;
    }
    
    // Part 2: test the corner cases for insert() and erase()
    {
        std::cout << "\nTESTING the corner cases for insert() and erase()" << std::endl;
        Essay essay;
        Essay::iterator ptr = essay.begin();
        ptr = essay.insert(ptr, "banana");
        assert(print(essay) == "banana");
        std::cout << "Insert banana:  " << print(essay) << std::endl;
        assert(*ptr == "banana");
        ptr = essay.insert(ptr, "apple");
        std::cout << "Insert apple before banana:  " << print(essay) << std::endl;
        assert(print(essay) == "apple banana");
        ptr++;
        assert(*ptr == "banana");
        ptr = essay.insert(ptr, "MIDDLE");
        std::cout << "Insert MIDDLE before banana:  " << print(essay) << std::endl;
        assert(print(essay) == "apple MIDDLE banana");
        assert(*ptr == "MIDDLE");
        ptr++;
        ptr++;
        assert(ptr == NULL);
        ptr = essay.insert(ptr, "carrot");
        std::cout << "Insert carrot after banana:  " << print(essay) << std::endl;
        assert(print(essay) == "apple MIDDLE banana carrot");
        
        ptr = essay.erase(ptr);
        assert(ptr == NULL);
        std::cout << "Erase carrot in the end:  " << print(essay) << std::endl;
        assert(print(essay) == "apple MIDDLE banana");
        ptr = essay.begin();
        ptr++;
        ptr = essay.erase(ptr);
        assert(*ptr == "banana");
        std::cout << "Erase MIDDLE in the middle:  " << print(essay) << std::endl;
        assert(print(essay) == "apple banana");
        ptr--;
        assert(*ptr == "apple");
        ptr = essay.erase(ptr);
        assert(*ptr == "banana");
        std::cout << "Erase apple in the beggining:  " << print(essay) << std::endl;
        assert(print(essay) == "banana");
        ptr = essay.erase(ptr);
        assert(ptr == NULL);
        std::cout << "Erase banana the last word:  " << print(essay) << std::endl;
        assert(print(essay) == "");
    }
    
    // Part 3: test the corner cases for backup() and revert()
    
    // Part 4: test the corner cases for splice()
    {
        std::cout << "\nTESTING the corner cases for splice()" << std::endl;
        // create a short sentence
        Essay my_essay = load("the quick brown fox jumped over the lazy dogs");
        assert(print(my_essay) == "the quick brown fox jumped over the lazy dogs");
        std::cout << "To start: " << print(my_essay) << std::endl;
        ...
        splice_end++;
        splice_end++;
        Essay::iterator destination = my_essay.end();
        // verify the positioning
        assert (*splice_begin == "quick");
        assert (*splice_end == "fox");
        ...
        bool success = my_essay.splice(splice_begin,splice_end,destination);
        assert (success == true);
        std::cout << "Cut (quick brown) and paste to the end: " << print(my_essay) << std::endl;
        assert (print(my_essay) == "the fox jumped over the lazy dogs quick brown");
        ...
        splice_begin++;
        assert(*splice_begin == "quick");
        splice_end = my_essay.end();
        destination = my_essay.begin();
        success = my_essay.splice(splice_begin,splice_end,destination);
        assert (success == true);
        std::cout << "Cut (quick brown) from the end and paste to the beginning:\n  " << print(my_essay) << std::endl;
        assert(print(my_essay) == "quick brown the fox jumped over the lazy dogs");
    }
