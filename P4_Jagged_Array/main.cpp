...
// My own tests, similar to MoreTests
void MyTests_int(){
    ...
    assert (d.getElement(0,0) == 4);
    assert (d.getElement(1,0) == 2);
    assert (d.getElement(1,1) == 5);
    assert (d.getElement(2,0) == 1);
    assert (d.getElement(2,1) == 3);
    assert (d.getElement(2,2) == 6);
    assert (d.getElement(2,3) == 7);
    d.print();
    d.pack();
    assert (d.isPacked());
    d.print();
    ...
    assert (e.getElement(0,0) == 4);
    assert (e.getElement(1,0) == 2);
    assert (e.getElement(1,1) == 5);
    assert (e.getElement(2,0) == 1);
    assert (e.getElement(2,1) == 3);
    assert (e.getElement(2,2) == 6);
    assert (e.getElement(2,3) == 7);
    e.print();
    ...
    std::cout << "MyTests with int COMPLETED." << std::endl;
...
void MyTests_str(){
    ...
    std::cout << "MyTests with std::string COMPLETED." << std::endl;
